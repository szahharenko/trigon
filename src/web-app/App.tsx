        ...
        cookies.disclaimer !== true ?
          <div className='disclaimer'>
              <div>
                ...
                <ul>
                  <li>1.	Käesoleva veebilehe sisu on avaldanud AS Trigon Asset Management (registrikood 11339670; aadress Pärnu mnt 18, Tallinn 10141, Eesti).</li>
                  <li>2.	AS Trigon Asset Management tegevusloaga eurofondi fondivalitseja ning allub Finantsinspektsiooni järelevalvele.</li>
                  <li>3.	See veebisait, sealhulgas kogu saadaolev teave, ei ole suunatud ega mõeldud ühelegi isikule ega üksusele, kes on resident või kelle asukohariik on riigis, kus Trigon Dividendifondi kohta teabe levitamine rikuks kehtivaid seadusi või määrusi või kus AS Trigon Asset Management ei ole õigustatud fondi kohta infot avaldama.</li>
                  <li>4.	See veebisait, sealhulgas kogu saadaolev teave, ei kujuta endast müügipakkumist ega sellel veebisaidil esitatud fondide osakute ostmise pakkumist.</li>
                  <li>5.	Midagi sellel veebisaidil ei tohiks tõlgendada investeerimisnõustamisena või maksualase, õigusalase või muu nõuandena ning sellele ei tohi investeerimisotsuse tegemisel tugineda. Trigondividendifond.ee veebisaidile sisenejad peaksid sellel veebisaidil viidatud toodete sobivuse osas konsulteerima oma finantsnõustajatega.</li>
                  <li>6.	Investeeringut kaaludes tuleb olla teadlik järgmistest riskidest: Investeeringute väärtus ja nendest saadav tulu võib nii langeda kui ka tõusta ning investor võib saada tagasi alginvesteeringust vähem; fondi senine tootlus ei garanteeri samasugust tootlust tulevikus.</li>
                  <li>7.	Fondi prospektide ja muude dokumentide (nt investori põhiteabe dokumendid, majandusaasta aruanne, poolaastaaruanne) kehtivad versioonid on kättesaadavad sellel veebilehel ja soovi korral saab neid küsida AS’ilt Trigon Asset Management.</li>
                  <li>8.	Selleks, et investeerimisotsuseid saaks teha informeeritud alusel, palume tutvuda asjakohaste fondi pakkumise alusdokumentidega. Enne investeerimist veenduge, et mõistate fondi olemust ja sellega kaasnevaid spetsiifilisi riske, et teha kindlaks, kas fond on teie jaoks sobiv toode.</li>
                  <li>9.	AS Trigon Asset Management ei garanteeri, et see veebisait või mis tahes sisu on vigadeta, rahuldava kvaliteediga või mis tahes konkreetseks otstarbeks sobiv. Vastutate täielikult veebisaidi kasutamise ja mis tahes sisule tuginemise tagajärgede eest.</li>
                  <li>10.	AS Trigon Asset Management loobub seadusega lubatud maksimaalses ulatuses igasugusest vastutusest teie ees, mis tuleneb teie veebisaidi kasutamisest. Eelkõige ei vastuta AS Trigon Asset Management teile investeeringu tulemusel tekkida võiva mis tahes otsese või kaudse kahju eest, mis tahes saamata jäänud kasumi või väärtuse kaotuse eest.</li>
                  <li>11.	Kogu sellel veebisaidil olev sisu on kaitstud autoriõigusega. Kui AS Trigon Asset Management pole selleks nõusolekut andnud, ei tohi sellel veebisaidil või selle kaudu juurdepääsetavat sisu, materjale ega pilte ühelgi viisil kopeerida, reprodutseerida, uuesti avaldada, üles laadida, postitada, edastada ega levitada.</li>
                </ul>
